...
(function () {
     ...
     * @constructor
     * @class Entrophy
     * Entrophy is a singleton designed to calculate the entrophy value of a user's password based on
     * the National Institute of Standards and Technology special publication 800-63.
     * http://csrc.nist.gov/publications/nistpubs/800-63-1/SP-800-63-1.pdf (Appendix A: Estimating Entrophy and Strength)
     * @param pw {String} The user's password.
     */
    Entrophy = function (pw) {
        ...
        this.password = pw;
        this.entrophy = (charset.size <= 0) ? 0 : Math.floor(Math.log(charset.size) * (pw.length / Math.log(2))) + compBits + dictBits;
        this.inDict   = (dictBits === 0 && Entrophy.DICT[pw.toLowerCase()]);  // true if password is in the dictionary
        this.charset  = charset;  // info about the size of the character set used to calculate the entrophy
    };
    ...
    Entrophy.prototype = {
        ...
        /**
         * @attr entrophy {Number} The calculated entrophy value.
         */
        entrophy: 0,
         ...
         *      calculating entrophy. "size" attribute is the number of possible
         ...
         * Determine how many "bits" to add to the entrophy value for a given password
         ...
         * Calculates the size of the character set used for the entrophy calculation
         * and the number of character sets the password inhabits.
         * @param pw {String} The user's password.
         * @return {Object} Size and count of the character set to use for calculating entrophy.
        ...
        getCharsetInfo: function (pw) {
            var rx=Entrophy.CHARSET_RX, size=0, count=0;
         ...
         * Determine how many "bits" to add to the entrophy value based on the password's
        ...
        calcDictionaryBits: function (pw) {
            var ln = pw.length;
            return ( ln>=4 && ln<20 && !Entrophy.DICT[pw.toLowerCase()] ) ? Math.min(ln, 6) : 0;
        }
